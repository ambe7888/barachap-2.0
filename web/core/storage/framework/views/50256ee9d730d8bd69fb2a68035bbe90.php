                            ...
                            <form action="<?php echo e(route('admin.add.new.service')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div  class="add-listing-content-wrapper mt-4">
                                    <div class="tab-content add-listing-content" id="add-listing-tabContent">
                                        ...
                                        <?php echo $__env->make('backend.pages.services.admin.service-general-info', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <!-- Service general Info end-->

                                        <!-- Service include start-->
                                       <?php echo $__env->make('backend.pages.services.admin.service-include', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        <!-- Service include end-->
                                    </div>
                                </div>
                            </form>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('backend.pages.services.admin.service-add-more-option-js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
        (function ($) {
            "use strict";
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\barachap\web\core\resources\views/backend/pages/services/admin/create-service.blade.php ENDPATH**/ ?>