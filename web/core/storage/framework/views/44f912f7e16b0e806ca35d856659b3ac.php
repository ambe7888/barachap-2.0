            ...
            <div class="loginForm__left">
                <div class="loginForm__left__inner desktop-center">
                    ...
                    <div class="loginForm__header">
                        <h2 class="loginForm__header__title text-start"><?php echo e(get_static_option('admin_login_page_title') ?? __('Welcome Back')); ?></h2 class="loginForm__header__title text-start">
                        <p class="loginForm__header__para text-start"><?php echo e(get_static_option('admin_login_page_subtitle') ?? __('Login with your data that you entered during registration.')); ?> </p>
                    </div>
...
<?php echo $__env->make('layouts.login-screens', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\barachap\Installable-file\Admin Panel\core\resources\views/auth/admin/login.blade.php ENDPATH**/ ?>