...
<div class="single-input mb-3 <?php echo e($class); ?>">
    ...
    <div class="media-upload-btn-wrapper">
        ...
        <button type="button" class="cmnBtn btn_5 btn_bg_secondary radius-5 media_upload_form_btn" data-btntitle="<?php echo e(__('Select Image')); ?>" data-modaltitle="<?php echo e(__('Upload Image')); ?>" data-imgid="<?php echo e($id ?? ''); ?>" data-bs-toggle="modal" data-bs-target="#media_upload_modal">
...
<?php /**PATH C:\xampp\htdocs\barachap\web\core\resources\views/components/backend/image.blade.php ENDPATH**/ ?>