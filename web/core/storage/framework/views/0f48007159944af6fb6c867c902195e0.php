                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title"><?php echo e(__('Admin All Services')); ?></h4>
                        ...
                        <div class="dashboard__inner__header__right">
                            <div class="d-flex">
                                <div class="btn-wrapper me-2">
                                   <a href="<?php echo e(route('admin.add.new.service')); ?>" class="cmnBtn btn_5 btn_bg_blue radius-5"><?php echo e(__('Add Service')); ?></a>
                                </div>
                            </div>    
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="search_notice_result">
                            <?php echo $__env->make('backend.pages.services.admin.search-service', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.bulk-action-js','data' => ['url' => route('admin.bulk.action.service')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\barachap\web\core\resources\views/backend/pages/services/admin/admin-services.blade.php ENDPATH**/ ?>