    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.update_admin_password',function(){
                ...
                if (password == '') {
                    toastr_warning_js("<?php echo e(__('Password field is required.')); ?>")
                    return false
                }
            });
        });
...
<?php /**PATH C:\xampp\htdocs\barachap\web\core\Modules/RolePermission\resources/views/admin-manage/admin-js.blade.php ENDPATH**/ ?>