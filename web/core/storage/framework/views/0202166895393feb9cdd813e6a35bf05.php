<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('All Provider Services')); ?>
                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title"><?php echo e(__('All Provider Services')); ?></h4>
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="search_notice_result">
                            <?php echo $__env->make('backend.pages.services.search-service', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.bulk-action-js','data' => ['url' => route('admin.service.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
        ...
        (function(){
            ...
            $(document).ready(function(){
                ...
                $(document).on('keyup','.notice_string_search',function(){
                    ...
                    $.ajax({
                        url:"<?php echo e(route('admin.service.search')); ?>",
                        method:'GET',
                ...
                function notices(page){
                    $.ajax({
                        url:"<?php echo e(route('admin.service.paginate').'?page='); ?>" + page,
                        success:function(res){
                            $('.search_notice_result').html(res);
                        }
                    });
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\barachap\web\core\resources\views/backend/pages/services/all_services.blade.php ENDPATH**/ ?>