<table class="dataTablesExample">
    ...
    <?php $__currentLoopData = $all_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            ?>
            <?php if($subOrder && $subOrder->staff): ?>
                <td>
                    <div class="table_customer">
                        <div class="table_customer__flex">
                            <div class="table_customer__thumb">
                                <?php echo render_image_markup_by_attachment_id($subOrder->staff->image); ?>

                            </div>
                            <div class="table_customer__contents">
                                <h6 class="table_customer__title"><?php echo e($subOrder->staff->fullname); ?></h6>
                            </div>
                        </div>
                    </div>
                </td>
            <?php else: ?>
                <td>
                    <div class="table_customer">
                        <div class="table_customer__flex">
                            <div class="table_customer__contents">
                                <h6 class="table_customer__title"><?php echo e(__('N/A')); ?></h6>
                            </div>
                        </div>
                    </div>
                </td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon.view-icon','data' => ['url' => route('admin.main.order.details',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\xampp\htdocs\barachap\web\core\resources\views/backend/pages/orders/admin-orders/search-order.blade.php ENDPATH**/ ?>