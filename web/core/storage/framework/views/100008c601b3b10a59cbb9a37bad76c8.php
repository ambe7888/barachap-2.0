<script>
    (function ($){
        ...
        $('.dark_mode_check').on('click', function(){
            var mode = $("#darkModeValue").val();
            $.ajax({
                type:'GET',
...
<?php /**PATH C:\xampp\htdocs\barachap\web\core\resources\views/components/popup/default-js-popup.blade.php ENDPATH**/ ?>