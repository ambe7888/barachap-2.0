    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            function countries(page){
                $.ajax({
                    url:"<?php echo e(route('admin.job.paginate.delete.data').'?page='); ?>" + page,
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.job.delete.search')); ?>",
                    method:'GET',
...
<?php /**PATH C:\xampp\htdocs\barachap\web\core\Modules/JobPost\resources/views/backend/jobs/delete-job-js.blade.php ENDPATH**/ ?>