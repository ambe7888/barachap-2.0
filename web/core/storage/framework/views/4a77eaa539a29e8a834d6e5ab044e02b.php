...
<head>
    ...
    <title>Software Install Wizard By <?php echo e(config('installer.author')); ?></title>
    ...
    <div class="get-support">
        <div class="icon-wrap">
            <ul class="support-list">
                <li><a href="<?php echo e(config('installer.website')); ?>" target="_blank">Visit Website</a></li>
                <li><a href="mailto:<?php echo e(config('installer.email')); ?>">Contact Support</a></li>
            </ul>
            ...
            <div class="col-lg-10">
                <div class="form-outer-wrapper">
                    <div class="brand-logo">
                        <h2 class="title"><?php echo e(config('installer.author')); ?></h2>
                    ...
                    <form id="msform" action="index.php" method="post">
                        ...
                        <div class="content-wrap with-step">
                            ...
                            <table class="requirement-check">
                                ...
                                <tr>
                                    ...
                                    <td>Required <strong>PHP</strong> version <?php echo e(config('installer.php_version')); ?></td>
                                    <td>
                                        <?php if(\Xgenious\Installer\Helpers\InstallationHelper::php_version()): ?>
                                ...
                                $ext_list = [];
                                ?>
                                <?php $__currentLoopData = \Xgenious\Installer\Helpers\InstallationHelper::extensions(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ext): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <tr>
                                    <td><strong><?php echo e(ucwords($ext)); ?></strong></td>
                                    <td>Required <strong><?php echo e(ucwords($ext)); ?></strong> PHP Extension</td>
                                    <td>
                                            <?php if(\Xgenious\Installer\Helpers\InstallationHelper::extension_check($ext)): ?>
                                                <div class="icon check"><i class="las la-check-circle" aria-hidden="true"></i></div>
                                            <?php else: ?>
                                               <?php
                                                   $ext_list[] = $ext;
                            ...
                            <?php if($ext_errors > 0): ?>
                            <div class="alert alert-danger mt-2" style="text-transform: capitalize;">contact your hosting provider to install or enable <strong><?php echo e(implode(',',$ext_list)); ?></strong> php extensions</div>
                            <?php endif; ?>
                        ...
                        <div class="content-wrap with-step">
                            ...
                            <table class="requirement-check">
                                ...
                                <?php
                                    ...
                                    $fol_list = [];
                                ?>
                                <?php $__currentLoopData = \Xgenious\Installer\Helpers\InstallationHelper::folders(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fold): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><strong><?php echo e($fold); ?></strong></td>
                                    <td>Required <strong>Permission: 0775</strong></td>
                                    <td>
                                        <?php if(\Xgenious\Installer\Helpers\InstallationHelper::folder_permission($fold)): ?>
                                            <div class="icon check"><i class="las la-check-circle" aria-hidden="true"></i></div>
                                        <?php else: ?>
                                            <?php
                            ...
                            <div class="alert alert-danger mt-2" style="text-transform: capitalize;">give permission 0755 to <strong><?php echo e(implode(', ',$fol_list)); ?></strong> folder</div>
                            <?php endif; ?>
                            <button type="button" class="previous action-button">Previous</button>
                            <button type="button"
                                    class="next action-button"
                        ...
                        <div class="content-wrap with-step">
                            ...
                            <table class="requirement-check">
                                ...
                                <tr>
                                    ...
                                    <td id="database_check_icon_td">
                                        <?php if(\Xgenious\Installer\Helpers\InstallationHelper::has_database_file()): ?>
                                            <div class="icon check"><i class="las la-check-circle" aria-hidden="true"></i></div>
                                            <?php else: ?>
                                            <div class="icon close"><i class="las la-times-circle" aria-hidden="true"></i></div>
                                        <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <button type="button" class="previous action-button">Previous</button>
                            <button type="button" id="database_check_next_btn" class="next action-button" <?php if(!\Xgenious\Installer\Helpers\InstallationHelper::has_database_file()): ?> disabled <?php endif; ?> > Next</button>
                        </div>
                        <div class="content-wrap with-step">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="copyright-inner">
                    &copy; <?php echo e(date('Y')); ?> All Right Reserved By <a href="<?php echo e(config('installer.website')); ?>"><?php echo e(config('installer.author')); ?></a>
                </div>
            </div>
        </div>
    </div>
    ...
    $(document).ready(function ($) {
        ...
        $(document).on('click','#check_database',function (e){
            ...
            if (validateDatabaseField()){
                ...
                $.ajax({
                    type: 'POST',
                    url: `<?php echo e(route('installer.check-database')); ?>`,
                    data:{
        ...
        $(document).on('click','#install_now',function (e){
            ...
            if (validateAdminField()){
                ...
                $.ajax({
                    type: 'POST',
                    url: `<?php echo e(route('installer.install')); ?>`,
                    data:{
                        '_token' : `<?php echo e(csrf_token()); ?>`,
                        'db_name' : $('input[name="database_name"]').val(),
                        'db_username' : $('input[name="database_username"]').val(),
        ...
        * */
        ...
        $(document).on('click','#folder_permission_next_btn',function (e){
            ...
            $.ajax({
                type: 'GET',
                url: `<?php echo e(route('installer.check-database.exists')); ?>`,
                success: function (data){
        ...
        $(document).on('click','#verify_purchase',function (e){
            ...
            if (validatePurchaseField()){
                ...
                $.ajax({
                    type: 'POST',
                    url: `<?php echo e(route('installer.verify-purchase')); ?>`,
                    data:{
                        '_token' : `<?php echo e(csrf_token()); ?>`,
...
</html><?php /**PATH C:\xampp\htdocs\barachap\web\core\vendor\xgenious\installer\src/../resources/views/installer/index.blade.php ENDPATH**/ ?>