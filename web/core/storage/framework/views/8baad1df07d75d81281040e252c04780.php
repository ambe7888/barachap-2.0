        ...
        $(document).ready(function(){
            ...
            $('#state_id').on('change', function() {
                ...
                if (state) {
                        ...
                        success: function (res) {
                            if (res.status == 'success') {
                                ...
                                if (all_cities.length <= 0) {
                                    $(".info_msg").html('<span class="text-danger"> <?php echo e(__('No state found for selected state!')); ?> <span>');
                                } else {
                                    $(".info_msg").html('');
                                }
                            }
                    ...
                    $(".get_state_city").html("<option value=''><?php echo e(__('Select City')); ?></option>");
                    $(".info_msg").html('');
                }
            });
            ...
            function countries(page){
                $.ajax({
                    url:"<?php echo e(route('admin.area.paginate.data').'?page='); ?>" + page,
                    success:function(res){
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('admin.area.search')); ?>",
                    method:'GET',
...
<?php /**PATH C:\xampp\htdocs\barachap\web\core\Modules/CountryManage\resources/views/area/area-js.blade.php ENDPATH**/ ?>