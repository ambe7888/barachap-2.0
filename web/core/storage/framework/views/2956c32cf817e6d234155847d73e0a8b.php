            ...
            <td>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('city-edit')): ?>
                        <a class="cmnBtn btn_5 btn_bg_warning radius-5 edit_city_modal"
                            ...
                            data-state="<?php echo e($city->state_id); ?>"
                            data-timezone="<?php echo e($city->timezone); ?>">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\barachap\web\core\Modules/CountryManage\resources/views/city/search-result.blade.php ENDPATH**/ ?>