    ...
    (function($){
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.swal_status_change',function(e){
                    e.preventDefault();
                    Swal.fire({
                        title: '{{__("Are you sure to change it? Once you done you can not revert this !!")}}',
                        icon: 'warning',
            ...
            $(document).on('click','.cover-letter',function(){
                let coverLetterContent = $(this).data('cover-letter');
            ...
            function notices(page){
                $.ajax({
                    url:"{{ route('client.offer-job.paginate').'?page='}}" + page,
                    success:function(res){
                        $('.search_result').html(res);
                    }
                });
