            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between">
                    ...
                    <div class="right-content d-flex">
                        @if($job->send_offer == 0)
                            <div>
                            <a class="cmnBtn btn_5 btn_bg_info radius-5" href="{{route('provider.job.offer.send',$job->id)}}">{{__('Send Job Offer')}}</a>
                            </div>
                        @endif
                        <div class="ms-2">
                            <a class="cmnBtn btn_5 btn_bg_info radius-5" href="{{route('provider.all.jobs')}}">{{__('All Jobs')}}</a>
                         </div>
                    </div>
                </div>
                <x-validation.error/>
