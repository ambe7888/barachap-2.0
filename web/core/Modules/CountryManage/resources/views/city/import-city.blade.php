                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="text-info">{{ __('Select your states state') }}</p>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <p class="text-info">{{ __('Select state and only unique states added automatically according to the selected state.') }}</p>
                                            </td>
                                        </tr>
