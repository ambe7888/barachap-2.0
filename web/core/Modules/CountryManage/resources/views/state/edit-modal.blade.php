            ...
            <div class="popup_contents__header">
                <div class="popup_contents__header__flex">
                    <div class="popup_contents__header__contents">
                        <h2 class="popup_contents__header__title">{{ __('Edit State') }}</h2>
                    </div>
            ...
            <div class="popup_contents__body">
                <form action="{{route('admin.state.edit')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form__input__single">
                        <label for="title" class="label-title">{{__('State')}}</label>
                        <input type="text" name="edit_state" id="edit_state" value="{{ old('state') }}" placeholder="{{ __('Enter state') }}" class="form-control" >
                    </div>
