                    ...
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            ...
                            <div class="btn-wrapper">
                                <a class="cmnBtn btn_5 btn_bg_secondary radius-5 btn-sm mb-3 mr-1"
                                   href="{{route('admin.page.edit',$page->id)}}">
                                    {{__('Go Back')}}
                                </a>
                                <a class="cmnBtn btn_5 btn_bg_blue radius-5 btn-sm mb-3 mr-1" href="{{route('admin.page')}}">
                                    {{__('All pages')}}
                                </a>
                                <a class="cmnBtn btn_5 btn_bg_info radius-5 btn-sm mb-3 mr-1" target="_blank"
                                   href="{{route('frontend.dynamic.page',$page->slug)}}">
                                    ...
                                    @if($page->layout === 'normal_layout' || $page->layout === 'home_page_layout' || $page->layout === 'home_page_layout_two')
                                        <div class="page-builder-area-wrapper extra-title">
                                            ...
                                            <ul id="dynamic_page"
                                                ...
                                                {!! \plugins\PageBuilder\PageBuilderSetup::get_saved_addons_for_dynamic_page('dynamic_page',$page->id) !!}
                                            </ul>
                                        </div>
                                    @endif
                                    @if($page->layout === 'home_page_layout' || $page->layout === 'home_page_layout_two')
                                        <div class="page-builder-area-wrapper extra-title">
                                            ...
                                            <ul id="dynamic_page_with_sidebar"
                                                ...
                                                {!! \plugins\PageBuilder\PageBuilderSetup::get_saved_addons_for_dynamic_page('dynamic_page_with_sidebar',$page->id) !!}
                                            </ul>
                                        </div>
                                    @endif
                                    ...
                                    @if($page->layout === 'home_page_layout_two')
                                        <div class="page-builder-area-wrapper extra-title">
                                            ...
                                            <ul id="dynamic_page_with_sidebar_two"
                                                class="sortable available-form-field main-fields sortable_widget_location margin-bottom-15">
                                                {!! \plugins\PageBuilder\PageBuilderSetup::get_saved_addons_for_dynamic_page('dynamic_page_with_sidebar_two',$page->id) !!}
                                            </ul>
                                        </div>
                                    @endif
