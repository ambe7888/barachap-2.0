        ...
        <tr>
            ...
            <td>
                <div class="d-flex">
                    ...
                    <a href="{{ route('admin.refunded-order.details', $data->id) }}" class="cmnBtn btn_5 btn_bg_info radius-5 me-2">
                        {{ __('View') }}
                    </a>
                    <a href="{{ route('admin.main.order.details', $data->order_id) }}" class="cmnBtn btn_5 btn_bg_info radius-5">
                        {{ __('Order Info') }}
                    </a>
                </div>
        </tr>
