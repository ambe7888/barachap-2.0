<div class="invoice-details-flex">
    ...
    <div class="invoice-single-details" style="float:right">
        ...
        <ul class="details-list">
        @php
            $location = $order_details->subOrderLocations?->firstWhere('sub_order_id', $order_details->id);
        @endphp
...
<div class="item-description" style="margin-top: 150px!important;">
