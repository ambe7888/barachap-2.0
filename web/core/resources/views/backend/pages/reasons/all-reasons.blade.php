...
@section('content')
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="custom_table style-04 search_result">
                            @include('backend.pages.reasons.search-result')
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('backend.pages.reasons.add-modal')
    @include('backend.pages.reasons.edit-modal')
@endsection
@section('scripts')
    @can('report-reason-bulk-delete')
    ...
    @endcan
    <x-media.js/>
    @include('backend.pages.reasons.reason-js')
@endsection
