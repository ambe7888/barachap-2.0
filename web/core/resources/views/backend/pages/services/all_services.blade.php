                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title">{{ __('All Provider Services') }}</h4>
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="search_notice_result">
                            @include('backend.pages.services.search-service')
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    @can('user-service-bulk-delete')
        <x-bulk-action.bulk-action-js :url="route('admin.service.bulk.action')"/>
    @endcan
        ...
        (function(){
            ...
            $(document).ready(function(){
                ...
                function notices(page){
                    $.ajax({
                        url:"{{ route('admin.service.paginate').'?page='}}" + page,
                        success:function(res){
                            $('.search_notice_result').html(res);
                        }
                    });
