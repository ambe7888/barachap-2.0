...
@if($notification->type =='service')
    ...
    @if($service)
    <a href="{{ route('provider.service.details',  ['id' => $notification->identity, 'notificationId' => $notification->id]) }}" class="dashboard__notification__list__item click-notification">
...
@if($notification->type =='job-created')
    ...
    @if($job)
            <a href="{{ route('provider.jobs.details', ['id' => $notification->identity, 'notificationId' => $notification->id]) }}" class="dashboard__notification__list__item click-notification">
            <li class="dashboard__header__notification__wrap__list__item">
                <div class="dashboard__header__notification__wrap__list__flex">
                    <div class="dashboard__header__notification__wrap__list__icon">
                        <i class="las la-bell"></i>
...
@if($notification->type =='order')
    ...
    @if($order)
        <a href="{{ route('provider.order.details', ['id' => $notification->identity, 'notificationId' => $notification->id]) }}" class="dashboard__notification__list__item click-notification">
            <li class="dashboard__header__notification__wrap__list__item">
                <div class="dashboard__header__notification__wrap__list__flex">
                    <div class="dashboard__header__notification__wrap__list__icon">
                        <i class="las la-bell"></i>
...
@if($notification->type =='ticket' || $notification->type =='ticket-update')
    ...
    @endphp
        ...
        @if($ticket)
            <a href="{{ route('provider.ticket.details',  ['id' => $notification->identity, 'notificationId' => $notification->id]) }}" class="dashboard__notification__list__item click-notification">
                <li class="dashboard__header__notification__wrap__list__item">
                    <div class="dashboard__header__notification__wrap__list__flex">
                        <div class="dashboard__header__notification__wrap__list__icon">
                            <i class="las la-bell"></i>
...
@if($notification->type =='withdraw')
    @php
        $withdraw = \App\Models\WithdrawRequest::find($notification->identity);
    @endphp

    @if($withdraw)
        <a href="{{ route('provider.withdraw.request.details',  ['id' => $notification->identity, 'notificationId' => $notification->id]) }}" class="dashboard__notification__list__item click-notification">
            <li class="dashboard__header__notification__wrap__list__item">
                <div class="dashboard__header__notification__wrap__list__flex">
                    <div class="dashboard__header__notification__wrap__list__icon">
                        <i class="las la-bell"></i>
