        ...
        <tr>
            ...
            <td>
                ...
                @elseif($data->payment_status == 'pending')
                    {{-- <span><x-status.status-change :url="route('provider.order.change.status',$data->id)"/></span> --}}
                @endif
            </td>
            <td>
                <span class="my-2">
            ...
            <td>
                <x-icon.view-icon :url="route('provider.order.details',$data->id)"/>

                <x-icon.file-icon :url="route('provider.order.invoice.generate',$data->id)"/>
            </td>
        </tr>
    @endforeach
    </tbody>
