                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{route('admin.withdraw.settings')}}" method="POST">
                                @csrf
                                <x-form.text
                                ...
                                <div class="btn_wrapper mt-4">
                                    <button type="submit" id="update" class="cmnBtn btn_5 btn_bg_blue radius-5 update_info">{{ __('Update') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
