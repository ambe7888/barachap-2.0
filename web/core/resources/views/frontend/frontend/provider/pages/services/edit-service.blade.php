                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="add-listing-wrapper mt-4">
                                ...
                                <form action="{{route('provider.edit.service', $service->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div  class="add-listing-content-wrapper mt-4">
                                        <div class="tab-content add-listing-content" id="add-listing-tabContent">
                                            <!-- service Info start-->
                                           @include('frontend.frontend.provider.pages.services.edit-service-details')
                                            <!-- service Info end-->
                                            <!-- Location start-->
                                            @include('frontend.frontend.provider.pages.services.edit-service-include')
                                            <!-- Location end-->
                                        </div>
                                    </div>
                                </form>
