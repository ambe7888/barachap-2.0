...
@section('content')
    <div class="row g-4 w-100 mt-0">
        <div class="col-xl-12 col-lg-12 mt-0 ms-4">
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between mb-4">
                    ...
                    <div class="right-content">
                        <a class="cmnBtn btn_5 btn_bg_info radius-5" href="{{route('provider.services.list')}}">{{__('All Services')}}</a>
                    </div>
                </div>
                <x-validation.error/>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="add-listing-wrapper mt-4">
                            ...
                            <form action="{{route('provider.add.new.service')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div  class="add-listing-content-wrapper mt-4">
                                    <div class="tab-content add-listing-content" id="add-listing-tabContent">
                                        ...
                                        @include('frontend.frontend.provider.pages.services.service-general-info')
                                        <!-- Service general Info end-->

                                        <!-- Service include start-->
                                       @include('frontend.frontend.provider.pages.services.service-include')
                                        <!-- Service include end-->
                                    </div>
                                </div>
                            </form>
...
@section('scripts')
    ...
    @include('frontend.frontend.provider.pages.services.service-add-more-option-js')
    <script>
        (function ($) {
            "use strict";
