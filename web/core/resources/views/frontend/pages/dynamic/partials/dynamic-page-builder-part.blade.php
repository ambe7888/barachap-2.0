        ...
        <div class="container {{$page_post->page_class}}">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 {{$page_post->right_column}} widg ">
                    <div class="widget-area-wrapper custom-margin-widget @if(get_static_option('site_frontend_dark_mode') === 'on')   dark-version  @endif style-{{$page_post->widget_style}}" data-padding-bottom="0">
