...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $lang_file_path = resource_path('lang/' . $request->slug . '.json');
        $default_lang_file_path = resource_path('lang/default.json');

        if (file_exists($lang_file_path)) {
            $backend_default_lang_data = file_get_contents($lang_file_path);
        } elseif (file_exists($default_lang_file_path)) {
            $backend_default_lang_data = file_get_contents($default_lang_file_path);
        }    
