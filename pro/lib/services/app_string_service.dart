...
class AppStringService with ChangeNotifier {
  ...
  static const Map<String, String> _frenchFallback = {
    ...
    "Enter phone": "Ex: 0123456789",
    "Long press and move to select location.": "Appui long et déplacez pour sélectionner l'emplacement.",
    "Choose a service area you like to work": "Choisissez une zone de service où vous souhaitez travailler",
    "Your Service Types": "Vos types de service",
    "Choose maximum 5 categories from below which you would like to  offer for customers": "Choisissez au maximum 5 catégories ci-dessous que vous souhaitez proposer aux clients",
    ...
    "Create service": "Créer un service",
    "create service": "Créer un service",
    "Jobs I Applied": "Demandes soumises",
    "Jobs i applied": "Demandes soumises",
    ...
    "Select state": "Choisir une région",
    "Select State": "Choisir une région",
    ...
    "Earnings": "Gains",
    "Pending orders": "Missions en attente",
    "Completed orders": "Missions terminées",
    "Total orders": "Total des missions",
    "Orders Completed": "Missions terminées",
    "Order's scheduled for Today": "Missions prévues aujourd'hui",
    "new orders are waiting for you.": "nouvelles missions vous attendent.",
    ...
    "Pay & Confirm Order": "Payer et confirmer la mission",
    "Change Language": "Changer de langue",
    "Language": "Langue",
    "Select language": "Choisir la langue",
    "Language changed successfully.": "Langue modifiée avec succès.",
    "No orders found": "Aucune mission trouvée",
    ...
    "Write about your job": "Décrivez votre demande",
    ...
    "Your job has been posted. You will get application's after it gets approved by an admin": "Votre demande a été publiée. Vous recevrez des candidatures après approbation par un administrateur",
    "Job Posted": "Demande publiée",
    "Last Seen": "Dernière connexion",
    "Report Job": "Signaler la demande",
    "Apply to Job": "Faire une offre",
    ...
    "My Orders": "Mes missions",
    "Job List": "Liste des demandes clients",
    ...
    "Sign Up": "S'inscrire",
    "Pending Orders": "Missions en attente",
    "Order in Progress": "Mission en cours",
    "Total Orders": "Total des missions",
    "Staffs": "Personnel",
    ...
    "Overall completion rate from your orders. If you have completed 70 of 100 orders you received then your completion rate will be 70%.": "Taux d'accomplissement global de vos missions. Si vous avez terminé 70 des 100 missions reçues, votre taux d'accomplissement sera de 70%.",
