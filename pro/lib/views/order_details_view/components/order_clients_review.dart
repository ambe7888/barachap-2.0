...
class OrderClientsReview extends StatelessWidget {
  final OrderDetails orderDetails;
  const OrderClientsReview({super.key, required this.orderDetails});
  ...
  Widget build(BuildContext context) {
    ...
    Review? clientsReview;
    bool gotReviewed = false;
        ...
        : Container(
            ...
            child: Column(
              ...
              children: [
                ...
                6.toHeight,
                RatingBar.builder(
                    initialRating: clientsReview!.rating.toDouble(),
                    itemSize: 24,
                ...
                4.toHeight,
                Text(
                  timeago.format(clientsReview.createdAt ?? DateTime.now(),
