...
class ClientProfileController extends Controller
{
    ...
    public function userProfile(){
        return view('frontend.frontend.client.pages.profile.edit-profile');
    }
    ...
    public function userPassword(){
        return view('frontend.frontend.client.pages.profile.change-password');
    }

    public function accountDeletePage()
    {
        $reasons=Reason::where('status',1)->get();
        return view('frontend.frontend.client.pages.profile.account-delete',compact('reasons'));
    }
