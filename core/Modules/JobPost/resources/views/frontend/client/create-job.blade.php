        ...
        <div class="col-xl-10 col-lg-10">
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex" style="display: flex; justify-content: space-between; align-items: center;">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title">{{ __('Add New Job') }}</h4>
                        </div>
                ...
                <div class="customMarkup__single__inner mt-4">
                    <form action="{{route('client.jobs.create')}}" enctype="multipart/form-data" method="POST">
                        @csrf
                            <div class="mb-30 row">
                            ...
                            <div class="mb-30 row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="date" name="date" id="date" class="form-control"  placeholder="{{ __('Date') }}"  value="{{old('date')}}">
                                </div>
                                <div class="form-group col-6">
                                    <label for="time" class="label_title"> {{ __('Time') }} <span class="text-danger">*</span> </label>
                                    <input type="text" name="time" id="time" class="form-control"  placeholder="{{ __('Time') }}"  value="{{old('time')}}">
                                </div>
                            </div>
                            ...
                            <div class="mb-30 row">
                                <div class="form-group col-6">
                                    ...
                                    <input type="number" name="budget" id="budget" class="form-control"  placeholder="{{ __('Budget') }}" value="{{ old('budget') }}">
                                </div>
            ...
            if (savedData) {
                ...
                $('#address').change(function() {
                    if ($(this).val() == '0') {
                        ...
                        window.location.href = "{{ route('client.location.add', ['flag' => 'from-job']) }}"; 
                    }
                });
