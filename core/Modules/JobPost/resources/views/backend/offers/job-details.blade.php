            ...
            <div class="dashboard__card bg__white padding-20 radius-10">
                <div class="header-wrap d-flex justify-content-between">
                    ...
                    <div class="right-content">
                        <a class="cmnBtn btn_5 btn_bg_info radius-5" href="{{route('admin.jobs.all')}}">{{__('All Jobs')}}</a>
                    </div>
                </div>
                <x-validation.error/>
                                    ...
                                    <div class="customer__account__details">
                                                ...
                                                <div class="customer__account__details__item__flex">
                                                    <div class="customer__details__author__thumb">
                                                        <div class="seller-img">
                                                           {!! render_image_markup_by_attachment_id($job->client?->image, '', 'thumb') !!}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="customer__account__details__item">
                                                <div class="customer__account__details__item__flex">
                                                    ...
                                                    <span>{{ optional($job->client)->fullname }}</span>
                                                </div>
                                            </div>
                                            <div class="customer__account__details__item">
                                                <div class="customer__account__details__item__flex">
                                                    <strong>{{ __('Email') }}</strong>
                                                    <span>{{ optional($job->client)->email }}</span>
                                                </div>
                                            </div>
                                            <div class="customer__account__details__item">
                                                <div class="customer__account__details__item__flex">
                                                    <strong>{{ __('Phone') }}</strong>
                                                    <span>{{ optional($job->client)->phone }}</span>
                                                </div>
                                            </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xxl-4 col-lg-4">
                                <div class="editProduct__contents">
                                    ...
                                    <div class="editProduct__contents__category mt-3">
                                        ...
                                        <input class="effectBorder" type="checkbox" @if(!empty($job->is_featured)) checked @endif>
                                    ...
                                    <div class="editProduct__contents__brand mt-3">
                                        <span class="editProduct__contents__sku__para"><strong>{{ __('Address:') }}</strong> {{ $job->job_location?->phone }}</span>
                                    </div>
                                    <div class="editProduct__contents__brand mt-3">
                                        <span class="editProduct__contents__sku__para"><strong>{{ __('Address:') }}</strong> {{ $job->job_location?->post_code }}</span>
                                    </div>
                                </div>
                            </div>
                            <!--step two -->
