...
class RolePermissionController extends Controller
{
    ...
    public function edit_role(Request $request)
    {
        ...
        if (!$role) {
            return back()->with(FlashMsg::error(__('Role not found')));
        }
        $role->update([
            'name' => $request->role_name,
        ]);
        return back()->with(FlashMsg::item_new(__('Role Successfully Updated')));
    }
    ...
    public function create_permission(Request $request,$id)
    {
        ...
        return back()->with(FlashMsg::item_new(__('Permission Successfully Synced with Role')));
    }
    ...
    public function delete_role($id)
    {
        ...
        $role->delete();
        return back()->with(FlashMsg::item_new(__('Role Successfully Deleted')));
    }
}
