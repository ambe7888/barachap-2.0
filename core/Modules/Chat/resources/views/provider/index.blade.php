                            ...
                            <div class="chat-wrapper-contact">
                                <div class="chat-wrapper-contact-close">
                                    ...
                                    <ul class="chat-wrapper-contact-list">
                                        @foreach($provider_chat_list as $provider_chat)
                                            <x-chat::provider.client-list :providerChat="$provider_chat" />
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="chat-wrapper-details-footer profile-border-top d-none" id="freelancer-message-footer">
                                    <div class="chat-wrapper-details-footer-form custom-form">
                                        ...
                                        <div class="chat-wrapper-details-footer-btn d-flex justify-content-end align-items-center gap-3 mt-3">
                                            ...
                                            <div>
                                                <a href="javascript:void(0)" class="btn btn-primary" id="provider-send-message-to-client">{{ __('Send Message') }}</a>
                                            </div>    
...
@section('scripts')
    ...
    <x-chat::livechat-js />
    <x-chat::provider.provider-chat-js />
