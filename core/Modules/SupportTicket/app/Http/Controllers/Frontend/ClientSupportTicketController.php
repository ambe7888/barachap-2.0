...
class ClientSupportTicketController extends Controller
{
    public function ticket(Request $request)
    {
        ...
        return view('supportticket::frontend.client-ticket.tickets',compact(['tickets','departments','users']));
    }
    ...
    public function paginate(Request $request)
    {
        ...
        if($request->ajax()){
            ...
            return $tickets->total() >= 1
                ? view('supportticket::frontend.client-ticket.search-result', compact('tickets'))->render()
    ...
    public function ticket_details(Request $request, $id,$notificationId=null){
        ...
        return !empty($ticket_details) ? view('supportticket::frontend.client-ticket.details',compact('ticket_details')) : back();
    }
