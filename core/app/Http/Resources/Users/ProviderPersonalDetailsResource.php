...
class ProviderPersonalDetailsResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'services' => $this->services ? ServiceSummaryResource::collection($this->services) : null, // Paginated services
            'reviews' => $this->services ? ProviderReviewResource::collection($this->reviews) : null, // Paginated reviews
            'provider_staffs' => StaffResource::collection($this->providerStaff) // Paginated staffs
        ];
    }
}
