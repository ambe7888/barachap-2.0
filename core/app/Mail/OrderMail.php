...
class OrderMail extends Mailable
{
    ...
    public function __construct(public $subject, public $order_details, public string $messageBody = "", public $user_type = 1)
    {
    }
    ...
    public function build()
    {
        ...
        $orderMessageBody = view("mail.order-mail-body.new-order-mail",compact('order_details','user_type'))->render();
