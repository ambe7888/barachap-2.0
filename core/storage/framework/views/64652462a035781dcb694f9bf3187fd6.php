...
<li class="dashboard__bottom__list__item has-children <?php if(request()->is('admin/tax/*')): ?> active open <?php endif; ?>">
    ...
    <ul class="submenu" style="<?php if(request()->is('admin/tax/*')): ?> display:block; <?php endif; ?>">
...
<li class="dashboard__bottom__list__item has-children <?php if(request()->is('admin/location/*')): ?> active open <?php endif; ?>">
    <a href="javascript:void(0)"><i class="las la-globe"></i>
        <span class="icon_title"><?php echo e(__('Location Manage')); ?></span>
    </a>
    <ul class="submenu" style="<?php if(request()->is('admin/location/*')): ?> display:block; <?php endif; ?>">
        ...
        <li class="dashboard__bottom__list__item <?php if(request()->is('admin/location/state/all-state')): ?> selected <?php endif; ?>">
            <a href="<?php echo e(route('admin.state.all')); ?>"><?php echo e(__('All States')); ?></a>
        </li>
        <?php endif; ?>
        ...
        <li class="dashboard__bottom__list__item <?php if(request()->is('admin/location/area/all-area')): ?> selected <?php endif; ?>">
            <a href="<?php echo e(route('admin.area.all')); ?>"><?php echo e(__('All Areas')); ?></a>
        </li>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('area-csv-file-import')): ?>
        <li class="dashboard__bottom__list__item <?php if(request()->is('admin/location/area/csv/import')): ?> selected <?php endif; ?>">
            <a href="<?php echo e(route('admin.area.import.csv.settings')); ?>"><?php echo e(__('Import Areas')); ?></a>
        </li>
        <?php endif; ?>
    </ul>
</li>
...
<li class="dashboard__bottom__list__item has-children <?php if(request()->is('admin/payment-settings/*') || request()->is('admin/payment-gateway/currency-settings')): ?> active open <?php endif; ?>">
    ...
    <ul class="submenu" style="<?php if(request()->is('admin/payment-settings/*') || request()->is('admin/payment-gateway/currency-settings')): ?> display:block; <?php endif; ?>">
        ...
        <li class="dashboard__bottom__list__item <?php if(request()->is("admin/payment-settings/payment/cash-on-delivery")): ?> selected <?php endif; ?>">
            <a class="text-capitalize" href="<?php echo e(route("admin.payment.settings.cod")); ?>"><?php echo e(__('cash on delivery')); ?></a>
        </li>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('live-chat-settings')): ?>
    <li class="dashboard__bottom__list__item <?php if(request()->routeIs('admin.pusher.settings')): ?> active <?php endif; ?>">
        <a href="<?php echo e(route('admin.pusher.settings')); ?>"><i class="lab la-rocketchat"></i>
            <span class="icon_title"><?php echo e(__('Chat Settings')); ?></span>
        </a>
    </li>
<?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\barachap\web\core\resources\views/backend/partials/module-list.blade.php ENDPATH**/ ?>