...
<?php $__env->startSection('content'); ?>
    <?php if($page_post->page_builder_status === 'on'): ?>
        <?php if(!auth()->guard('web')->check() && $page_post->visibility === 'all'): ?>
            <?php echo $__env->make('frontend.pages.dynamic.partials.dynamic-page-builder-part',['page_post' => $page_post], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <?php endif; ?>
    <?php else: ?>
        <?php echo $__env->make('frontend.pages.dynamic.partials.dynamic-content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\barachap\core\resources\views/frontend/pages/dynamic/dynamic-single.blade.php ENDPATH**/ ?>