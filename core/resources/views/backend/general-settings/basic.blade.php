        ...
        <div class="dashboard__card bg__white padding-20 radius-10">
            ...
            <form action="{{route('admin.general.basic.settings')}}" method="POST" class="validateForm" enctype="multipart/form-data">
                ...
                <div class="form__input__flex">
                    ...
                    <div class="form__input__single">
                        <label for="site_address" class="form__input__single__label">{{ __('Site Address') }}</label>
                        <input type="text" name="site_address"  class="form__control radius-5" value="{{get_static_option('site_address')}}" id="site_address">
                    </div>

                    <div class="form__input__single">
                        <label for="site_email" class="form__input__single__label">{{ __('Site Email') }}</label>
                        <input type="text" name="site_email"  class="form__control radius-5" value="{{get_static_option('site_email')}}" id="site_email">
                    </div>

                    <div class="form__input__single">
                        <label for="site_phone" class="form__input__single__label">{{ __('Site Phone') }}</label>
                        <input type="text" name="site_phone"  class="form__control radius-5" value="{{get_static_option('site_phone')}}" id="site_phone">
                    </div>
