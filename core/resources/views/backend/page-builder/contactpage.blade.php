        ...
        <div class="row">
            ...
            <div class="col-lg-12 mt-t">
                <div class="card margin-bottom-30">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Contact Page Builder settings')}}</h4>
                        <div class="alert alert-info">{{__('if you enable page builder, your contact page will load only page builder content.')}}</div>
                        <form action="{{route('admin.contact.page.builder')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="contact_page_page_builder_status"
                                           @if(!empty(get_static_option('contact_page_page_builder_status'))) checked @endif >
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="page-builder-wrap"
                             class="margin-top-50 page-builder-content-wrap @if(get_static_option('contact_page_page_builder_status')) d-block @else d-none @endif">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="page-builder-area-wrapper">
                                        <ul id="sortable"
                                            class="sortable available-form-field main-fields sortable_widget_location">
                                            {!! \App\PageBuilder\PageBuilderSetup::get_saved_addons_by_location('contactpage') !!}
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-6">
