                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title">{{ __('Admin All Services') }}</h4>
                        ...
                        <div class="dashboard__inner__header__right">
                            <div class="d-flex">
                                <div class="btn-wrapper me-2">
                                   <a href="{{ route('admin.add.new.service') }}" class="cmnBtn btn_5 btn_bg_blue radius-5">{{ __('Add Service') }}</a>
                                </div>
                            </div>    
                ...
                <div class="tableStyle_three mt-4">
                    <div class="table_wrapper custom_Table">
                        <div class="search_notice_result">
                            @include('backend.pages.services.admin.search-service')
                        </div>
                    </div>
                </div>
            </div>
...
@section('scripts')
    @can('admin-service-bulk-delete')
        <x-bulk-action.bulk-action-js :url="route('admin.bulk.action.service')"/>
    @endcan
        ...
        (function(){
            ...
            $(document).ready(function(){
                ...
                $(document).on('keyup','.notice_string_search',function(){
                    ...
                    $.ajax({
                        url:"{{ route('admin.search.service') }}",
                        method:'GET',
                ...
                function notices(page){
                    $.ajax({
                        url:"{{ route('admin.paginate.service').'?page='}}" + page,
                        success:function(res){
                            $('.search_notice_result').html(res);
                        }
                    });
