                    ...
                    <div class="customMarkup__single__item">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <div class="custom_table style-04 search_result">
                                @include('backend.pages.withdraw.search-result')
                            </div>
                            <!-- Table End -->
                        </div>
                    </div>
    ...
    <div class="modal fade" id="edit-request-modal" tabindex="-1" aria-labelledby="edit-gateway-modalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="" method="POST" action="{{ route('admin.withdraw.request.update') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <div class="btn_wrapper">
                            <button type="submit" id="update" class="cmnBtn btn_5 btn_bg_blue radius-5 update_request_status">{{ __('Update') }}</button>
                        </div>
                    </div>
                </form>
            </div>
