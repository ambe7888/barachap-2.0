                                        ...
                                        @foreach ($gateways as $gateway)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <x-popup.delete-popup :url="route('admin.withdraw.gateway.delete',$gateway->id)"/>
                                                    @endcan
                                                    @can('withdraw-payment-status-change')
                                                         <span><x-status.status-change :url="route('admin.withdraw.gateway.status', $gateway->id)"/></span>
                                                   @endcan
                                                </td>
                                            </tr>
                                        @endforeach
            ...
            <div class="col-lg-5">
                <div class="dashboard__card sideWarapper__item bg__white padding-20 radius-10">
                        <div class="dashboard__card__header">
                            <h4 class="dashboard__card__title">{{ __('Withdraw Payment Gateway Create') }}</h4>
                        </div>
                        <div class="dashboard__card__body custom__form customMarkup__single">
                            <x-validation.error />
                            <form method="POST" action="{{ route('admin.withdraw.gateway.create') }}">
                                @csrf
