        ...
        <div class="hero-grid">
            <div class="hero-left">
                ...
                <div class="popular-tags">
                    ...
                    <a href="{{ url('/services?q=Coiffure') }}">Coiffure</a>
                    <a href="{{ url('/services?q=Plomberie') }}">Plomberie</a>
                    <a href="{{ url('/services?q=Ménage') }}">Ménage</a>
                    <a href="{{ url('/services?q=Électricité') }}">Électricité</a>
                </div>
            </div>
            
            <div class="hero-right">
                <div class="hero-circle-bg"></div>
                <img src="{{ asset('assets/frontend/img/client-app-preview.png') }}" alt="BaraChap Client App" class="app-showcase-img" style="z-index: 2; position: relative;">
            </div>
        </div>
    </section>
    ...
    <section class="services-section">
            ...
            @foreach($categories->take(6) as $cat)
                <div class="service-card">
                    <div class="service-icon-wrapper">
                        @if(!empty($cat->image))
                            {!! render_image_markup_by_attachment_id($cat->image, 'cat-icon') !!}
                        @else
                            <i class="{{ $cat->icon ?? 'fa-solid fa-layer-group' }}"></i>
                        @endif
                    </div>
                    <h3>{{ $cat->name }}</h3>
                    <p>{{ \Illuminate\Support\Str::limit($cat->description ?? '', 100) }}</p>
                </div>
            @endforeach
        </div>
        ...
        @if($categories->count() > 6)
            <div style="text-align: center; margin-top: 40px; font-size: 1.15rem; color: var(--text-muted); font-weight: 600; font-family: var(--font-heading);">
                ...
                {{ __('Et bien d\'autres catégories de services disponibles sur l\'application...') }}
            </div>
        @endif
    </section>
    ...
    <section class="features-section">
        <div class="features-grid">
            <div class="features-left">
                <img src="{{ asset('assets/frontend/img/provider-app-preview.png') }}" alt="BaraChap Provider App" class="app-showcase-img">
            </div>
    ...
    <section class="cta-banner-section">
        <div class="cta-banner-grid">
            ...
            <div class="cta-card-box provider-cta">
                ...
                <a href="{{ route('user.register') }}" class="cta-link-btn">Devenir Prestataire</a>
            </div>
        </div>
    </section>
</div>
