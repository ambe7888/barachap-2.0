                ...
                <div class="dashboard__inner__header">
                    <div class="dashboard__inner__header__flex" style="display: flex; justify-content: space-between; align-items: center;">
                        <div class="dashboard__inner__header__left">
                            <h4 class="dashboard__inner__header__title">{{ __('Edit Location') }}</h4>
                        </div>
                        <div class="dashboard__inner__header__right">
                            <a href="{{route('client.location.map.edit',$location->id)}}" class="btn btn-primary">Edit Using Map</a>
                        </div>
                    </div>
                </div>
                <x-validation.error/>
                <div class="customMarkup__single__inner mt-4">
                    <form action="{{route('client.location.edit',$location->id)}}" enctype="multipart/form-data" method="POST">
                        @csrf
                            <div class="mb-30 row">
                            ...
                            <div class="mb-30 row">
                                ...
                                <div class="form-group col-6 mt-3">
                                    ...
                                    <input type="text" name="emergency_phone" id="emergency_phone" class="form-control"  placeholder="{{ __('Emergency Phone Number') }}" value="{{ $location->emergency_phone }}">
                                </div>
                            </div>
