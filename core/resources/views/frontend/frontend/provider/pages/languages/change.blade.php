        ...
        <div class="col-xl-8 col-lg-8">
            <div class="dashboard__card bg__white padding-20 radius-10">
                ...
                <div class="customMarkup__single__inner mt-4">
                    <form action="{{route('provider.change.language')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="form__input__single">
                                ...
                                <select name="selected_lang" id="selected_lang" class="select2_activation radius-5 form-control">
                                    ...
                                    @foreach($all_lang as $lang)
                                        <option value="{{ $lang->slug }}" @if($lang->slug  == $provider->selected_lang) selected @endif>{{ $lang->name }}</option>
                                    @endforeach
                                </select>
                            </div>
