<!--Status Modal -->
<div class="modal fade" id="SubOrderStatusChangeModalForAccept" tabindex="-1" role="dialog"
     aria-labelledby="editModal"
     aria-hidden="true">
    <form action="{{ route('provider.sub.order.status.accept.decline') }}" method="post">
        @csrf
