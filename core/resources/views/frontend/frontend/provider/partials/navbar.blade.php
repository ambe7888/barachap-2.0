            ...
            <div class="navbar-right-content">
                ...
                @else
                    <div class="after-login-content">
                        @include('frontend.frontend.provider.partials.notifications')
                        ...
                        <div class="profile-part">
                            ...
                            <div class="profile-item">
                                <div class="item"><a href="{{route('user.frontend.dashboard')}}">{{__('Dashbord')}}</a></div>
                                <div class="item"><a href="{{route('provider.profile.password.change')}}">{{__('Setting')}}</a></div>
                                <div class="logout"><a href="{{route('user.logout')}}">{{__('Log Out')}}</a></div>
                            </div>
                        </div>
