...
class OfferListTileProvider extends StatelessWidget {
  final ProviderModel provider;
  final bool ignoreGesture;

  const OfferListTileProvider(
      {super.key, required this.provider, this.ignoreGesture = false});
                  ...
                  children: [
                    ...
                    RichText(
                      ...
                      text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                                text: provider.completionRate != null
                                    ? "${provider.completionRate!.round()}% ${LocalKeys.completionRate}"
