...
abstract class LocalKeys {
  ...
  static const String _bookYoursFromAWideRange = "Book yours from a wide range of services listed by the professional handyman service providers & get your things done!";
...
//getter starts here
  ...
  static String get cancel => _cancel.tr();
    ...
    _welcomeToProhandy: _welcomeToProhandy,
    _bookExpertHandymen: _bookExpertHandymen,
    _bookFromServices: _bookFromServices,
    _bookYoursFromAWideRange: _bookYoursFromAWideRange,
    _postJobs: _postJobs,
    _didntFindWhatYoureLookingFor: _didntFindWhatYoureLookingFor,
    _state: _state,
    _area: _area,
    _city: _city,
    ...
    _passLeastCharWarning: _passLeastCharWarning,
    _passUpperCaseWarning: _passUpperCaseWarning,
    _passLowerCaseWarning: _passLowerCaseWarning,
    _passDigitWarning: _passDigitWarning,
    _passCharacterWarning: _passCharacterWarning,
    ...
    _signedInSuccessfully: _signedInSuccessfully,
    _emailUsernameValidateText: _emailUsernameValidateText,
    _favoriteServices: _favoriteServices,
    _pendingOrders: _pendingOrders,
    _completedOrders: _completedOrders,
    _totalOrders: _totalOrders,
    _ratingAndReviews: _ratingAndReviews,
    _supportTicket: _supportTicket,
    ...
    _editInformation: _editInformation,
    _changeEmail: _changeEmail,
    _changePhone: _changePhone,
    _changePassword: _changePassword,
    _firstName: _firstName,
    _enterFirstName: _enterFirstName,
    _lastName: _lastName,
    _enterLastName: _enterLastName,
    _saveChanges: _saveChanges,
    _verificationCodeWillBeSentToTheNewEmail: _verificationCodeWillBeSentToTheNewEmail,
    _email: _email,
    _enterNewEmail: _enterNewEmail,
    _sendVerificationCode: _sendVerificationCode,
    _sendingOtpToMail: _sendingOtpToMail,
    _resetPassword: _resetPassword,
    _passwordResetSuccessful: _passwordResetSuccessful,
    _verificationCode: _verificationCode,
    _enterYourVerificationCode: _enterYourVerificationCode,
    _doNotShareCode: _doNotShareCode,
    _didNotReceived: _didNotReceived,
    _resend: _resend,
    _sendAgain: _sendAgain,
    _wrongOTPCode: _wrongOTPCode,
    _resendCode: _resendCode,
    _enterEmail: _enterEmail,
    _verificationCodeWillBeSentToTheNewPhone: _verificationCodeWillBeSentToTheNewPhone,
    _enterPhone: _enterPhone,
    _enterYourPhoneVerificationCode: _enterYourPhoneVerificationCode,
    _currentPassword: _currentPassword,
    _enterYourCurrentPassword: _enterYourCurrentPassword,
    _newPassword: _newPassword,
    _enterNewPassword: _enterNewPassword,
    _reEnterNewPassword: _reEnterNewPassword,
    _confirmPassword: _confirmPassword,
    _passwordDidNotMatch: _passwordDidNotMatch,
    _delete: _delete,
    _newTicket: _newTicket,
    _active: _active,
    _closed: _closed,
    _createTicket: _createTicket,
    _title: _title,
    _enterTitle: _enterTitle,
    _department: _department,
    _selectDepartment: _selectDepartment,
    _selectPriority: _selectPriority,
    _priority: _priority,
    _newAddress: _newAddress,
    _addAddress: _addAddress,
    _enterZipCode: _enterZipCode,
    _zipCode: _zipCode,
    _emergencyPhoneNumber: _emergencyPhoneNumber,
    _office: _office,
    _overview: _overview,
    _reviews: _reviews,
    _faq: _faq,
    _ourOffers: _ourOffers,
    _whatIsNotIncluded: _whatIsNotIncluded,
    _safetyAndSecurity: _safetyAndSecurity,
    _cancellationPolicy: _cancellationPolicy,
    _bookService: _bookService,
    _serviceAddonsAndDate: _serviceAddonsAndDate,
    _addons: _addons,
    _dateAndSchedule: _dateAndSchedule,
    _selectDateAndSchedule: _selectDateAndSchedule,
    _availableSlots: _availableSlots,
    _bookingNoteExmp: _bookingNoteExmp,
    _addNote: _addNote,
    _select: _select,
    _choseStaff: _choseStaff,
    _package: _package,
    _addToCart: _addToCart,
    _proceedToPay: _proceedToPay,
    _cart: _cart,
    _connectionTimeout: _connectionTimeout,
    _errorOccurred: _errorOccurred,
    _yourPaymentWillTerminate: _yourPaymentWillTerminate,
    _yes: _yes,
    _invalidDeveloperKeys: _invalidDeveloperKeys,
    _loadingFailed: _loadingFailed,
    _paymentGateway: _paymentGateway,
    _username: _username,
    _enterUsername: _enterUsername,
    _cardNumber: _cardNumber,
    _invalidCardNumber: _invalidCardNumber,
    _cvvCvc: _cvvCvc,
    _expireDate: _expireDate,
    _orderSummery: _orderSummery,
    _shareDetails: _shareDetails,
    _bookingSuccessful: _bookingSuccessful,
    _billed: _billed,
    _paymentStatus: _paymentStatus,
    _orderStatus: _orderStatus,
    _orderDetails: _orderDetails,
    _requestToCancel: _requestToCancel,
    _downloadInvoice: _downloadInvoice,
    _requestToCancelDesc: _requestToCancelDesc,
    _id: _id,
    _schedule: _schedule,
    _sendMessage: _sendMessage,
    _pleaseWriteMessageOrSelectAFile: _pleaseWriteMessageOrSelectAFile,
    _pullDown: _pullDown,
    _noMessageFound: _noMessageFound,
    _signIn: _signIn,
    _password: _password,
    _enterPassword: _enterPassword,
    _forgotPassword: _forgotPassword,
    _rememberMe: _rememberMe,
    _doNotHaveAccount: _doNotHaveAccount,
    _signUp: _signUp,
    _otpSignIn: _otpSignIn,
    _signInFailed: _signInFailed,
    _signInWithGoogle: _signInWithGoogle,
    _signInWithFacebook: _signInWithFacebook,
    _signInWithApple: _signInWithApple,
    _or: _or,
    _byProceedingIAgreeToThe: _byProceedingIAgreeToThe,
    _haveAccount: _haveAccount,
    _signUpWithGoogle: _signUpWithGoogle,
    _signUpWithFacebook: _signUpWithFacebook,
    _signUpWithApple: _signUpWithApple,
    _retypePassword: _retypePassword,
    _verifyEmail: _verifyEmail,
    _uploadYourProfilePhoto: _uploadYourProfilePhoto,
    _uploadProfilePhoto: _uploadProfilePhoto,
    _skipForLater: _skipForLater,
    _clickToSelectPhoto: _clickToSelectPhoto,
    _youHaveSignedUpSuccessfully: _youHaveSignedUpSuccessfully,
    _enterValidEmailAddress: _enterValidEmailAddress,
    _enterTheOTP: _enterTheOTP,
    _serviceProvider: _serviceProvider,
    _about: _about,
    _services: _services,
    _staffs: _staffs,
    _totalStaff: _totalStaff,
    _serviceArea: _serviceArea,
    _added: _added,
    _categories: _categories,
    _searchOrChoseCategory: _searchOrChoseCategory,
    _seeAll: _seeAll,
    _choseLocation: _choseLocation,
    _useThisLocation: _useThisLocation,
    _searchLocation: _searchLocation,
    _selectALocationByMovingMap: _selectALocationByMovingMap,
    _choosePaymentMethod: _choosePaymentMethod,
    _applyCoupon: _applyCoupon,
    _enterCode: _enterCode,
    _payAndConfirmOrder: _payAndConfirmOrder,
    ...
    _clear: _clear,
    _offerDetails: _offerDetails,
    _providerHiredSuccessfully: _providerHiredSuccessfully,
    _paymentFailed: _paymentFailed,
    _providerHiredButPaymentProcessFailed: _providerHiredButPaymentProcessFailed,
    _contact: _contact,
    ...
    _deleteJobConfirmation: _deleteJobConfirmation,
    _deleteJobDescription: _deleteJobDescription,
    _jobDeletedSuccessfully: _jobDeletedSuccessfully,
    _openingMap: _openingMap,
    _officialPlatformProvider: _officialPlatformProvider,
    _refundPaymentMethod: _refundPaymentMethod,
    _updateRefundInfo: _updateRefundInfo,
    _orderCancelledSuccessfully: _orderCancelledSuccessfully,
    _selectAPaymentMethod: _selectAPaymentMethod,
    _status: _status,
    _requestRefund: _requestRefund,
    _sendRequest: _sendRequest,
    _refundRequestSentSuccessfully: _refundRequestSentSuccessfully,
    _refunds: _refunds,
    _infoUpdatedSuccessfully: _infoUpdatedSuccessfully,
    _somethingWentWrong: _somethingWentWrong,
    _updatePaymentInfo: _updatePaymentInfo,
    _update0: _update0,
    _noPaymentInfoFound: _noPaymentInfoFound,
    _refundAmount: _refundAmount,
    _status0: _status0,
    _refundRequest: _refundRequest,
    _refunded: _refunded,
