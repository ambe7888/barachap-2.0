...
extension SvgSizedExtension on String {
  Widget toSVGSized(double height, {color}) =>
      SvgPicture.asset('assets/icons/$this.svg', height: height, color: color);
}
...
extension NumConversionExtension on Object {
  num get tryToParse {
    ...
    String originalCurrency = objString
        .replaceAll(",", "")
...
extension AssetExtension on String {
  Widget toAImage({color, fit}) =>
      Image.asset('assets/images/$this.png', fit: fit);
}

extension AssetImageExtension on String {
  ImageProvider get toAsset => AssetImage('assets/images/$this.png');
}
